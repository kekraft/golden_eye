...
if("FALSE" STREQUAL "TRUE")
  set(launcher_SOURCE_PREFIX /home/gloin/AppliedRob/golden_eye_ws/src/launcher)
  set(launcher_DEVEL_PREFIX /home/gloin/AppliedRob/golden_eye_ws/devel)
  set(launcher_INSTALL_PREFIX "")
  set(launcher_PREFIX ${launcher_DEVEL_PREFIX})
else()
  set(launcher_SOURCE_PREFIX "")
  set(launcher_DEVEL_PREFIX "")
  set(launcher_INSTALL_PREFIX /home/gloin/AppliedRob/golden_eye_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'gloin <gloin@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'launcher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gloin/AppliedRob/golden_eye_ws/install/${idir}'.  Ask the maintainer 'gloin <gloin@todo.todo>' to fix it.")
    endif()
