...
if("FALSE" STREQUAL "TRUE")
  set(uvc_camera_SOURCE_PREFIX /home/gloin/AppliedRob/golden_eye_ws/src/camera_umd/uvc_camera)
  set(uvc_camera_DEVEL_PREFIX /home/gloin/AppliedRob/golden_eye_ws/devel)
  ...
  set(uvc_camera_INSTALL_PREFIX /home/gloin/AppliedRob/golden_eye_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'uvc_camera' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gloin/AppliedRob/golden_eye_ws/install/${idir}'.  Ask the maintainer 'Ken Tossell <ken@tossell.net>' to fix it.")
    endif()
