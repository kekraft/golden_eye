...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'pong_loader' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gloin/AppliedRob/golden_eye_ws/install/${idir}'.  Ask the maintainer 'gloin <gloin@todo.todo>' to fix it.")
    endif()
